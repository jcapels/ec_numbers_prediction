...
class UniprotXmlECNumbersParser(UniprotXmlParser):
    def __init__(self, filename, taxonomy_restrictions=None):
        self.filename = filename
        self.taxonomy_restrictions = taxonomy_restrictions
...
class UniprotEnzymesNonEnzymesXmlParser(UniprotXmlParser):

    def __init__(self, filename, taxonomy_restrictions=None):
        super().__init__(filename, taxonomy_restrictions)
...
if __name__ == "__main__":
    ...
    UniprotEnzymesNonEnzymesXmlParser("/home/jcapela/uniprot_parsing/tasks/uniprot_sprot.xml.gz").parse("swiss_prot_enzymes.csv")
