...
from ec_number_prediction.transfer_learning.fine_tuning_experiment import FineTuneExperimentTFvsNoTF_PlantsSMOrComplete, FineTuneExperimentTFvsNoTFWithoutValidation, FineTuneWithOptimization, FineTuneExperimentTFvsNoTF, FineTuneWithOptimizationForPlants
import os
import numpy as np
import optuna
import pandas as pd
...
def tf_no_tf_experiment():
    ...
    experiment = FineTuneExperimentTFvsNoTF(datasets=datasets, study_name="esm1b_experiment", storage="sqlite:///transfer_learning_experiment.db", sampler= optuna.samplers.RandomSampler(),
                                    ...
                                    base_layers=[2560, 5120], input_dim=1280, classification_neurons=643, results_output_file="results_esm1b_no_plants.csv")
...
def experiment_tf_no_tf_plants_sm():
    ...
    experiment = FineTuneExperimentTFvsNoTFWithoutValidation(datasets=datasets, study_name="esm1b_experiment_plants_sm", storage="sqlite:///transfer_learning_experiment.db", sampler= optuna.samplers.RandomSampler(),
                                    direction="maximize", load_if_exists=True, path_to_model=os.path.join(base_path, "pretrained_models/esm1b_no_plants.ckpt"),
                                    base_layers=[2560, 5120], input_dim=1280, classification_neurons=182, results_output_file="results_esm1_plants_sm.csv")
...
def experiment_tf_no_tf_plants_sm():
    ...
    for i in range(5):
        ...
        train_dataset.load_features(os.path.join(base_path_data, "swiss_prot_ec_plants_esm1b/"))
        test_dataset.load_features(os.path.join(base_path_data, "swiss_prot_ec_plants_esm1b/"))
        train_dataset_full.load_features(os.path.join(base_path_data, "swiss_prot_ec_plants_esm1b/"))
        
        datasets.append((train_dataset, test_dataset, train_dataset_full))
    
    experiment = FineTuneExperimentTFvsNoTF_PlantsSMOrComplete(datasets=datasets, study_name="esm1b_experiment_plants_sm", storage="sqlite:///transfer_learning_experiment.db", sampler= optuna.samplers.RandomSampler(),
                                    direction="maximize", load_if_exists=True, path_to_model=os.path.join(base_path, "pretrained_models/esm1b_no_plants.ckpt"),
                                    base_layers=[2560, 5120], input_dim=1280, classification_neurons=182, results_output_file="results_esm1b_plants_sm.csv")
...
def experiment_optimize_plants_sm():
    ...
    experiment = FineTuneWithOptimizationForPlants(datasets=datasets, study_name="esm1b_experiment_with_optimization_plants_sm", storage="sqlite:///transfer_learning_experiment.db", sampler= optuna.samplers.TPESampler(),
                                    direction="maximize", load_if_exists=True, path_to_model=os.path.join(base_path, "pretrained_models/esm1b_no_plants.ckpt"),
                                    base_layers=[2560, 5120], input_dim=1280, classification_neurons=182, results_output_file="results_esm1b_experiment_with_optimization_plants_sm.csv",
...
def train_model_and_evaluate_plants_sm():
    ...
    for i in range(5):
        ...
        module = FineTuneModelECNumber(input_dim=1280, additional_layers=[2560, 1280], classification_neurons=182, base_layers=[2560, 5120],
        ...
        results_all.to_csv(os.path.join(base_path, "train_models/results_esm1b_trial_35_plants_sm.csv"))
